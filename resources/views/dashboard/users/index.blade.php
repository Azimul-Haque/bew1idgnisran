              ...
              <tbody>
                ...
                @foreach($users as $user)
                    ...
                    <td>
                      ...
                      @endif
                			<button type="button" class="btn btn-warning btn-sm edit-user-btn" data-toggle="modal" data-target="#unlocDevecisModal{{ $user->id }}">
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          ...
                          <form method="post" action="{{ route('dashboard.logout-all-devices') }}">
                            ...
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-dismiss="modal">ফিরে যান</button>
                              <button type="submit" class="btn btn-primary">আনলক করুন</button>
                            </div>
                          </form>
                        </div>
                      </div>
