...
Route::post('logout-all', 'APIController@logoutFromAllDevices')->name('api.logout-all-devices');
...
Route::post('program/attend', 'APIController@storeProgramAtt')->name('api.attend.program');
Route::get('programs/{id}/attendees', 'APIController@getAttendees')->name('api.programs.attendees');
...
Route::get('/gallery/list', 'APIController@getGallery')->name('api.list.gallery');
...
Route::get('/election/manifesto/bnp', 'APIController@getElectionMenifestoBNP')->name('api.election.manifesto.bnp');
Route::get('/election/manifesto/narsingdi-1', 'APIController@getElectionMenifestoN1')->name('api.election.manifesto.narsingdi-1');
